    ...
    <div class="main-content slot-game">
        <div class="container">
            <div class="slot-game__container">
                <div class="page-header">JOKER GAMING</div>
                <div class="slot-game-list">
                    ...
                    while ($row = mysqli_fetch_array($query)) {
                        if (isset($_SESSION['username'])) {
                          $que = mysqli_query($koneksi, "SELECT * FROM tb_user WHERE extplayer = '$extplayer' AND status_game = 'ongame' ");

                          $cek = mysqli_num_rows($que);

                          if($cek > 0){
                            $link_url = "https://direct.smlss.fun/gs2c/opengame.do?";
                        }else{
                            if ($id_login == '') {
                                $link_url = "https://direct.smlss.fun/gs2c/opengame.do?";
                            }else{
                                $link_url = "https:\/\/direct.smlss.fun\/gs2c\/opengame.do?session";
                            }
