            ...
            <div class="row">
                <div class ="col-lg-12">
                    <div class="register__container">
                        <div class="page-header"><i class="fas fa-user-alt mr-2"></i>| <a href="https://script.kincai77.com/">Formulir Pendaftaran</a></div>
                        <form id="register-form" method="POST" action="function/daftar_akun.php" >
                            ...
                            <div class="register-form">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-lg-4 d-flex align-items-center justify-content-start">
                                            <label for="bank">Detail Account Bank</label>
                                        </div>
                                        <div class="col-lg-8">
                                ...
                                <div class="form-group" id="phoneInput">
                                    <div class="row">
                                        <div class="col-lg-4 d-flex align-items-center justify-content-start">
                                            <label for="phone">Nombor Fon</label>
                                        </div>
                                        <div class="col-lg-8">
                                            <div class="input-group">
                                                ...
                                                id="phone" minlength="8" maxlength="20" placeholder="Nombor fon" required="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group" id="accountName">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            ...
                                            placeholder="Name account bank" required="">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <label for="term" class="register-terms">
                                                <span class="text-justify">Saya telah berusia lebih dari 18 tahun, telah membaca, dan menerima <a href="https://script.kincai77.com">syarat dan ketentuan</a> yang dipasang di situs ini, peraturan pribadi, dan aturan taruhan.</span>
                                            </label>
                                        </div>
                                    </div>
                                </div>
