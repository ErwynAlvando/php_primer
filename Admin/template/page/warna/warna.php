								...
								<div class="form-group">
									...
									<div class="input-group mb-3">
										<select class="form-control" name="warna">
											<option value="abu-hitam" <?php echo ($selectedColor == 'abu-hitam') ? 'selected' : ''; ?>>Tosca-hitam (abu-hitam)</option>
											<option value="merah-kuning" <?php echo ($selectedColor == 'merah-kuning') ? 'selected' : ''; ?>>Kuning-Hitam (merah-kuning)</option>
											<option value="biru-kuning" <?php echo ($selectedColor == 'biru-kuning') ? 'selected' : ''; ?>>Pupple-hitam (biru-kuning)</option>			
										</select>
									</div>
								</div>
